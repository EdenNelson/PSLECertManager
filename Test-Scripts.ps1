...
<#
.SYNOPSIS
    Validates syntax for all project PowerShell scripts.
.DESCRIPTION
    Parses all main scripts to ensure they have valid PowerShell syntax.
#>
...
$scripts = @(
    ...
    'Register-CertificateScheduledTask.ps1',
    'PostScripts/Set-ADFSCert.ps1',
    'PostScripts/Set-WAPCert.ps1',
    'PostScripts/Set-CMCMGCert.ps1'
)
...
if ($errors -eq 0) {
    ...
    Write-Host "✗ $errors script(s) failed syntax validation" -ForegroundColor Red
    exit 1
}
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUCc0ep5+M3dl0ZDDzwiVwOfMY
# WhGgghk5MIIGFDCCA/ygAwIBAgIQeiOu2lNplg+RyD5c9MfjPzANBgkqhkiG9w0B
...
# DAYKKwYBBAGCNwIBFTAjBgkqhkiG9w0BCQQxFgQUhjRD5Y8lXqOeDns3swEi6rD8
# uvAwDQYJKoZIhvcNAQEBBQAEggEAG2jmWmaE7ATD9i/cyU7wdWEPVjb9TWT+a9XY
# MsjabFnC7G83ddbEF3vjlvrdKcuzCCBDlp7aeIgorH58q7NN5tg0zWsfZuugepns
# 0p35ft65Hry0iCVMmajnHcNDifTaqMtJE5MeEQfuR+zo5kbYwrXZV9TenkC6rNrq
# V0yGZZieQvwcPrJERJJY7TXETXIByp86AjF+eE+NJO4q3KSvy8wTwKoPww52mbO7
# 7hB4Z36m+5am//CaC86u8HMn+p2PdBPb99t67N6n7be8zEw/RQtubPOCr1EIgqxS
# pEe0ACDPdXqJJ0IuYB7B4+fqUfMwpc39aPL6CDXA2BxYdnU4g6GCAyMwggMfBgkq
...
# NDE3NDYxMVowPwYJKoZIhvcNAQkEMTIEME9XM61TwWwExk93N8q2G0zGRPUbpQ0q
# fAgi9gKwrQRvm97gzGtWdjBQZrCElJ7JoDANBgkqhkiG9w0BAQEFAASCAgAK8tQz
# YoLupvo9cimcRl+HjbQJ5fUx6r+Gt9mgBpDXTVJYDqzIur8te30o9vVhQCKWk5CB
# KVz5m4aAo9iVD827q13o6T/XwbaNCk8i39qsEi9EE1RcayyAfVFjmBl+uAZq3X9L
# CitpOqViWvQtAYEt7sCqZETj2jyZYwYjPAWs3SkVK7mGByMBxxG14htvsy/J+x84
# Lg9TgCXWMC/O8/TcShyicn5U1TZBirFa/GCp72j2A84PuQOHShYlpRVzywa9oxow
# y60WdjwoVBCxIJT23194snXH4cJ9sme8xeYhc148Zg4L1CXPXdAqdp8szqrTglQh
# BUrihcVJcFyhcL/p39qv4/Iu/jPA1gokhGXuZauqao64sZx+k17ZMA6xsycWSnwh
# PWQ5RoW/jAcJRVr//pceKvjAb+fdbuRsfbAqhS86TAGUN3dPOzP+zbqkiJ/5LYZf
# iFZu/JXPNlfumhYmlvA5DBV9tB9+9lxpmZMg0lA2rEZQjIjoTptau+QW5TBzmvOz
# AJy+JuNy1xcykL6c48so2AtFWR+YLYzUnOqWgf0J+niUBzpfnXnuEt9tBW6/hkxI
# qDcrNUCmbttPlQr9MVvomfyUk/0eUoEAEyPoTJOa6+CKJM1vfuum4xqdbCygB44F
# K+Po2rtPJiQhgSTRZkjlzDBi9KjbdBevMjieaQ==
